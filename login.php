...
<center><br>Pengaduan Masyarakat<br><br></center>
	...
	<form method="POST">
		...
		<br><center><p>belum punya akun? <a href='registrasi.php' title='registrasi' target='_blank'>registrasi</a></p></center>
...
<?php 
	if(isset($_POST['login'])){
		...
		elseif($cek2>0){
			...
			echo "<script>alert('Gagal Login,anda ingin mencoba lagi?')</script>";
